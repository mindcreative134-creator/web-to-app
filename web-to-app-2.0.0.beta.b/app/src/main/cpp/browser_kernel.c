...
"(function(){"
  ...
  "document.createElement=function(tag){"
    ...
    "if(tag.toLowerCase()==='iframe'){"
      "var _origGet=Object.getOwnPropertyDescriptor(HTMLIFrameElement.prototype,'contentWindow').get;"
...
"(function(){"
  ...
  "Object.getOwnPropertyDescriptor=function(obj,prop){"
    ...
    "if(obj===navigator&&(prop==='webdriver'||prop==='plugins'||prop==='mimeTypes'"
      ...
      "return{value:navigator[prop],writable:false,enumerable:true,configurable:true};"
    "}"
    "return _origDesc.call(this,obj,prop);"
  "};"
...
"(function(){"
  "var _suspects=['AndroidBridge','WebViewBridge','NativeBridge','__WTA_BRIDGE__',"
...
"(function(){"
  ...
  "window.Error=function(msg){"
    ...
    "if(e.stack){"
      "e.stack=e.stack.replace(/(?:webview|WebView|wv|evaluateJavascript)/gi,'chrome');"
    "}"
    "return e;"
  "};"
  "window.Error.prototype=_origError.prototype;"
  "window.Error.captureStackTrace=_origError.captureStackTrace;"
  "window.Error.stackTraceLimit=_origError.stackTraceLimit;"
  "_hookedFns.add(window.Error);"
"})();"
