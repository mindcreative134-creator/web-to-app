...
data class ApkConfig(
    ...
    val orientationMode: String = "PORTRAIT", // 屏幕方向模式: PORTRAIT, LANDSCAPE, AUTO
    ...
    val keepScreenOn: Boolean = false, // 保持屏幕常亮
    
    // 悬浮小窗配置
    val floatingWindowEnabled: Boolean = false,
    val floatingWindowSizePercent: Int = 80,     // 窗口大小百分比 50-100
