...
object ExtensionPanelScript {
    ...
    private fun convertFabIconToHtml(fabIcon: String): String {
        ...
        if (fabIcon.startsWith("custom:")) {
            ...
            return """<img src="data:image/png;base64,$base64" width="20" height="20" style="border-radius:4px;object-fit:contain">"""
        }
        // 预设图标 ID
...
(function() {
    ...
    const WTA_PANEL = {
        ...
        // 获取过滤后的模块列表
        getFilteredModules() {
            var all = this.modules.filter(function(m) {
                var uiType = (m.uiConfig && m.uiConfig.type) || UI_TYPE.FLOATING_BUTTON;
