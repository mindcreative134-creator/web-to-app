...
object SampleProjectManager {
    ...
    fun getSampleProjects(): List<SampleProject> {
        ...
        return listOf(
            ...
            SampleProject(
                id = "leaflet-bench-finder$suffix",
                name = Strings.sampleLeafletBenchName,
                description = Strings.sampleLeafletBenchDesc,
                framework = FrontendFramework.VITE,
                icon = "🗺️",
                tags = listOf("Leaflet", Strings.sampleLeafletBenchTagMap, Strings.sampleLeafletBenchTagGPS)
            )
        )
    }
