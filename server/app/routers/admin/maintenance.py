...
def system_stats(
    ...
    return ApiResponse(data={
        ...
        "Pro Users": pro_users,
        "Admins": admin_users,
        "Cloud Projects": total_projects,
        "Total Activation Codes": total_codes,
        "Used Codes": used_codes,
        "Community Modules": total_modules,
        "Announcements": total_announcements,
        "Audit Logs": total_audit_logs,
    })
...
def create_db_backup(
    ...
    try:
        ...
        return ApiResponse(success=False, message=f"Could not parse database connection: {str(e)}")
    ...
    try:
        ...
        return ApiResponse(success=False, message="Backup timeout (>120s)")
    except Exception as e:
...
def delete_backup(
    ...
    return ApiResponse(message=f"Backup deleted: {safe_name}")
